...
const pastErrors = visitDate && visitTime ? getPastSlotErrors(visitDate, visitTime) : {};

setFieldError("regVisitDateError", pastErrors.date || "");
setFieldError("regVisitTimeError", pastErrors.time || "");
});
});
